...
from robot_one.api.bingx.spot.rest.core import build_session
from robot_one.api.bingx.spot.ws.url import USER_AUTH_USER_DATA_STREAM
...
def request_update_listen_key(
    ...
    url = USER_AUTH_USER_DATA_STREAM
